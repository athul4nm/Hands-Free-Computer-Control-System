...
# --- Path Settings ---
# Folder names ningalude screenshot-ile pole accurate aayirikkanam
...
def stop_script():
    ...
    if current_process:
        ...
        # Process-ine poorna-maayum kill cheyyunnu
...
def start_script(script_path):
    ...
    if os.path.exists(script_path):
        ...
        # Sub-folder-il ninnu run cheyyaan 'cwd' (Current Working Directory) nalkunnu
